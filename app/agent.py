...
def run(user_message: str, history: list[dict] | None = None, session_id: str = "default",
    ...
    active_tools = repo.get_tools() or TOOLS
    ...
    for _ in range(max_rounds):
        msg = chat_with_tools(messages, active_tools, temperature=temperature, model=model)
    ...
    final = chat_with_tools(messages, active_tools, temperature=temperature, model=model)
